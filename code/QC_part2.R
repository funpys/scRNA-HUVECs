...
######## QC figure
HUVEC_3d_seurat = CreateSeuratObject(counts = counts(sce_drop_filtered), project = "HUVEC_3d")
...
HUVEC_3d_seurat = ScaleData(HUVEC_3d_seurat, vars.to.regress = c(
  "S.Score", "G2M.Score"))
...
# HUVEC_3d_seurat = RunTSNE(HUVEC_3d_seurat, dims = dim)
